...
1. A phased VCF file "output_haplotype_file.phased.vcf". The format of this file follows the standard VCF format. 

2. A phased block output file. The format of this file is described [here](outputformat.md)
