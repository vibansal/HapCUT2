...
$(B)/HAPCUT2: $(B)/fragmatrix.o $(B)/readinputfiles.o $(B)/pointerheap.o $(B)/common.o $(X)/hapcut2.c $(X)/find_maxcut.c $(HTSLIB)/libhts.a $(X)/post_processing.c| $(B)
	$(CC) -I$(HTSLIB) $(B)/common.o $(B)/fragmatrix.o $(B)/readinputfiles.o $(B)/pointerheap.o -o $(B)/HAPCUT2 -lm $(X)/hapcut2.c -L$(HTSLIB) -lhts 
...
$(B)/readinputfiles.o: $(X)/readinputfiles.h $(X)/readinputfiles.c $(HTSLIB)/libhts.a $(X)/common.h $(X)/fragmatrix.h | $(B)
	$(CC) -I$(HTSLIB) -c $(X)/readinputfiles.c -o $(B)/readinputfiles.o
