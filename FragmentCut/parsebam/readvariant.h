...
typedef struct 
{
	char* id; char* chrom; int position; 
	short altalleles; char* RA; char* AA; // alternate alleles
...
typedef struct 
{
	int variants; int first; int last; int blocks;
	int* intervalmap;
} CHROMVARS;
